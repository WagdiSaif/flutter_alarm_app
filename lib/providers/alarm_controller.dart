...
class AlarmController {
  ...
  Future<bool> canNavigateToRingingScreen(int id) async {
    ...
    await alarmSharedPrefs.reloadPreferences();
  ...
  Future<void> addCustomSound(String path) => _repository.addSound(path);
  Future<void> deleteSound(int id) => _repository.removeSoundById(id);
}
